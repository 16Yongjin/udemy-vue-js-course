...
const actions = {
    ...
    asyncIncrement: ({ commit }, payload) => setTimeout(() => commit('increment', payload.by), payload.duration),
    asyncDecrement: ({ commit }, payload) => setTimeout(() => commit('decrement', payload.by), payload.duration)
}
